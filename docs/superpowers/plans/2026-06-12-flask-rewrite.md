# ValBelluna Motorsport-Flask Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Rewrite ValBelluna Motorsport from FastAPI to Flask as a new project deployable on PythonAnywhere free tier.
...
**Files:**
- Create: `ValBelluna Motorsport-Flask/requirements.txt`
- Create: `ValBelluna Motorsport-Flask/.env`
- Create: `ValBelluna Motorsport-Flask/app/__init__.py`
- Create: `ValBelluna Motorsport-Flask/app/config.py`
- Create: `ValBelluna Motorsport-Flask/app/database.py` (copied from FastAPI)
- Create: `ValBelluna Motorsport-Flask/app/models.py` (copied from FastAPI)

- [ ] **Step 1: Create project directory**

Run:
```bash
mkdir -p /home/giovanni/Documents/ValBelluna Motorsport-Flask/app/blueprints
mkdir -p /home/giovanni/Documents/ValBelluna Motorsport-Flask/app/templates
mkdir -p /home/giovanni/Documents/ValBelluna Motorsport-Flask/app/templates/admin
mkdir -p /home/giovanni/Documents/ValBelluna Motorsport-Flask/app/static
mkdir -p /home/giovanni/Documents/ValBelluna Motorsport-Flask/tests
```
...
**Files:**
- Create: `ValBelluna Motorsport-Flask/app/auth.py`
...
**Files:**
- Create: `ValBelluna Motorsport-Flask/app/forms.py`
...
**Files:**
- Create: `ValBelluna Motorsport-Flask/app/blueprints/__init__.py`
- Create: `ValBelluna Motorsport-Flask/app/blueprints/auth.py`
...
**Files:**
- Create: `ValBelluna Motorsport-Flask/app/blueprints/participation.py`
...
**Files:**
- Create: `ValBelluna Motorsport-Flask/app/blueprints/races.py`
...
**Files:**
- Create: `ValBelluna Motorsport-Flask/app/blueprints/reports.py`
- Create: `ValBelluna Motorsport-Flask/app/blueprints/history.py`
...
**Files:**
- Modify: `ValBelluna Motorsport-Flask/app/__init__.py` (register blueprints, context processor, seed admin)
- Create: `ValBelluna Motorsport-Flask/app/cli.py`
